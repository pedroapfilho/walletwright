  ...
  <section className="mx-auto w-full max-w-6xl px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-muted-foreground mx-auto mt-6 max-w-[60ch] text-lg text-pretty sm:text-xl">
        walletwright onboards MetaMask, Phantom, and Slush from a seed, caches the profile, then
        unlocks and clicks through the connect and signature popups against your dapp. It covers
        EVM, Solana, and Sui with the real extensions, not mocks.
      </p>
